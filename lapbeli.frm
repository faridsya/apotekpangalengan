...
Begin VB.Form lapbeli 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   840
      OleObjectBlob   =   "lapbeli.frx":0000
      Top             =   2400
   End
   ...
   Begin VB.ComboBox Combo1 
      Height          =   315
      ItemData        =   "lapbeli.frx":0234
      Left            =   2280
      List            =   "lapbeli.frx":025C
      TabIndex        =   2
      Text            =   "bln"
      Top             =   1680
      Width           =   615
   ...
   Begin VB.ComboBox Combo2 
      Height          =   315
      ItemData        =   "lapbeli.frx":0287
      Left            =   3000
      List            =   "lapbeli.frx":02AF
      TabIndex        =   1
      Text            =   "tahun"
      Top             =   1680
      Width           =   855
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   375
      Left            =   1080
      OleObjectBlob   =   "lapbeli.frx":02FB
      TabIndex        =   7
      Top             =   960
      Width           =   1575
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   255
      Left            =   1080
      OleObjectBlob   =   "lapbeli.frx":0375
      TabIndex        =   8
      Top             =   480
      Width           =   1455
   End
End
Attribute VB_Name = "lapbeli"
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\pembelian.rpt"
  .RetrieveDataFiles
.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{pembelian.tanggal_pembelian}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd") & "# And {Pembelian.Tanggal_pembelian}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd") & "#"
...
b = Combo2.Text
.SelectionFormula = "month({pembelian.tanggal_pembelian})=" & Combo1.Text & " and year({pembelian.tanggal_pembelian})=" & Combo2.Text & ""
