...
Begin VB.Form lapbrg3 
   Caption         =   "Laporan Keluar masuk barang"
   ClientHeight    =   2520
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5040
   ...
   Begin VB.ComboBox cmbbarang 
      ...
      Width           =   2535
   End
   Begin ACTIVESKINLibCtl.SkinLabel Sampai 
      Height          =   255
      Left            =   240
      OleObjectBlob   =   "lapbrg3.frx":0000
      TabIndex        =   4
      Top             =   960
      Visible         =   0   'False
      Width           =   1335
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4320
      OleObjectBlob   =   "lapbrg3.frx":006A
      Top             =   1200
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   255
      Left            =   240
      OleObjectBlob   =   "lapbrg3.frx":029E
      TabIndex        =   2
      Top             =   480
      Width           =   1695
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   255
      Left            =   240
      OleObjectBlob   =   "lapbrg3.frx":030A
      TabIndex        =   6
      Top             =   1440
      Width           =   1335
   End
End
Attribute VB_Name = "lapbrg3"
...
If cmbbarang.Text = "semua" Then
sql = ""
Else
sql = " and{vkmbrg.deskripsi}='" & cmbbarang.Text & "'"
End If
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\outinbrg.rpt"
  .RetrieveDataFiles
'.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  .SelectionFormula = "{vkmbrg.kode_brg}<>'' " & sql & ""
