...
Begin VB.Form laphistori 
   Caption         =   "Laporan Histori Obat"
   ClientHeight    =   3570
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5040
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   600
      OleObjectBlob   =   "laphistori.frx":0000
      Top             =   3120
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   375
      Left            =   960
      OleObjectBlob   =   "laphistori.frx":0234
      TabIndex        =   10
      Top             =   2160
      Width           =   1095
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   255
      Left            =   960
      OleObjectBlob   =   "laphistori.frx":02A8
      TabIndex        =   8
      Top             =   960
      Width           =   1695
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   375
      Left            =   960
      OleObjectBlob   =   "laphistori.frx":0322
      TabIndex        =   7
      Top             =   480
      Width           =   1695
   End
...
On Error GoTo Pesan
If MsgBox("Cetak laporan histori harga?", vbYesNo, judul) = vbNo Then Exit Sub
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\historiharga.rpt"
  .RetrieveDataFiles
.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{histori_harga.tgl_ubah}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd") & "# And {histori_harga.tgl_ubah}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd") & "# " & tmbh & ""
...
b = Combo2.Text
.SelectionFormula = "month({histori_harga.tgl_ubah})=" & Combo1.Text & " and year({histori_harga.tgl_ubah})=" & Combo2.Text & " " & tmbh & ""
