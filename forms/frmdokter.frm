...
Begin VB.Form frmdokter 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   6480
      OleObjectBlob   =   "frmdokter.frx":0000
      Top             =   5280
   End
   ...
   Begin TabDlg.SSTab Tab1 
      ...
      TabPicture(0)   =   "frmdokter.frx":0234
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "frame"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Data dokter"
      TabPicture(1)   =   "frmdokter.frx":0250
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   360
         OleObjectBlob   =   "frmdokter.frx":026C
         TabIndex        =   16
         Top             =   3720
         Width           =   1455
      End
   ...
   End
End
Attribute VB_Name = "frmdokter"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False

Private Sub cmbsp_Click()
Cmdsimpan.SetFocus
End Sub

Private Sub cmbsp_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then
Cmdsimpan.SetFocus
End If
End Sub
...
sql = "delete from dokter where id_dokter='" & Text1.Text & "'"
jual.Execute (sql)
dbgrid
kosong
...
A = Text1.Text
rssupp.Open "select * from dokter where id_dokter='" & A & "'", jual, adOpenStatic, adLockOptimistic



If Edit = False Then
Set RS = New Recordset
RS.Open "select nama from dokter where nama='" & stri & "'", jual, adOpenStatic, adLockOptimistic
If Not RS.EOF Then
MsgBox "Nama dokter sudah ada,bedakan walau 1 huruf", vbInformation, judul
Text2.SetFocus
Exit Sub
End If
jual.Execute "insert into dokter values('" & Text1.Text & "','" & stri & "','" & text3.Text & "','" & text4.Text & "','" & cmbsp.Text & "')"
...
Else
Set RS = New Recordset
RS.Open "select nama from dokter where nama='" & stri & "' and id_dokter<>'" & Text1.Text & "'", jual, adOpenStatic, adLockOptimistic
If Not RS.EOF Then
MsgBox "Nama dokter sudah ada,bedakan walau 1 huruf", vbInformation, judul
Text1.SetFocus
Exit Sub
...
jual.Execute "update dokter set nama='" & stri & "',alamat='" & text3.Text & "',no_telp='" & text4.Text & "',spesialis='" & cmbsp.Text & "' where id_dokter='" & Text1.Text & "'"
frame.Enabled = False
...
Dim No As String
Set rssupp = New Recordset
sql = "Select id_dokter from dokter order by id_dokter Desc"
Set rssupp = jual.Execute(sql)
If rssupp.EOF = True Then
Text1.Text = "Dkr001"
Else
j = val(Right(rssupp(0), 3))
No = "Dkr" + Format(Str(j + 1), "000")
Text1.Text = No
End If
End Sub
...
cmbsp.Clear
sql = "select distinct spesialis from dokter where spesialis is not null and spesialis!='' order by spesialis"
Set rsbarang = jual.Execute(sql)
If Not rsbarang.EOF Then
rsbarang.MoveFirst
 Do While Not rsbarang.EOF
cmbsp.AddItem rsbarang!spesialis
rsbarang.MoveNext
 Loop
  End If
rsbarang.Close
