...
Begin VB.Form lapretur 
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4440
      OleObjectBlob   =   "lapretur.frx":0000
      Top             =   2280
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   375
      Left            =   960
      OleObjectBlob   =   "lapretur.frx":0234
      TabIndex        =   7
      Top             =   960
      Width           =   1575
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   255
      Left            =   960
      OleObjectBlob   =   "lapretur.frx":02AE
      TabIndex        =   8
      Top             =   480
      Width           =   1455
   End
End
Attribute VB_Name = "lapretur"
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\retur_beli.rpt"
  .RetrieveDataFiles
  .Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{retur_beli.tanggal}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd") & "# And {Retur_beli.tanggal}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd") & "#"
...
b = Combo2.Text
.SelectionFormula = "month({retur_beli.tanggal})=" & Combo1.Text & " and year({retur_beli.tanggal})=" & Combo2.Text & ""
