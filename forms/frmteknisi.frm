...
Begin VB.Form frmteknisi 
   ...
   Begin VB.PictureBox Picture3 
      ...
      Begin ACTIVESKINLibCtl.Skin Skin1 
         Left            =   4440
         OleObjectBlob   =   "frmteknisi.frx":0000
         Top             =   120
      End
   ...
   Begin TabDlg.SSTab Tab1 
      ...
      TabPicture(0)   =   "frmteknisi.frx":0234
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "frame"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Data teknisi"
      TabPicture(1)   =   "frmteknisi.frx":0250
...
frame.Enabled = False
kata = InputBox("Masukkan id teknisi atau nama teknisi", "Cari...")
If kata = "" Then Exit Sub
Cmdsimpan.Enabled = False
sql = "select* from teknisi where id_teknisi='" & kata & "' or nama_teknisi like '%" & kata & "%' "
...
sql = "delete from teknisi where id_teknisi='" & Text1.Text & "'"
jual.Execute (sql)
dbgrid
kosong
...
RS.Open "select * from teknisi where nama_teknisi='" & Text2.Text & "' and id_teknisi<>'" & Text1.Text & "'", jual, adOpenStatic, adLockOptimistic
If Not RS.EOF Then
...
rssupp.Open "select * from teknisi where id_teknisi='" & A & "'", jual, adOpenStatic, adLockOptimistic
If Edit = False Then
...
A = "TKN" & "%"
sql = "Select id_teknisi from teknisi where id_teknisi like '" & A & "' order by id_teknisi Desc"
Set rsplg = jual.Execute(sql)
If rsplg.EOF = True Then
Text1.Text = "TKN001"
Else
j = val(Right(rsplg(0), 3))
No = "TKN" + Format(Str(j + 1), "000")
Text1.Text = No
End If
End Sub
...
Sub dbgrid()
Set rssupp = New Recordset
sql = "select * from teknisi order by nama_teknisi"
Set rssupp = jual.Execute(sql)
