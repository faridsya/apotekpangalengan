...
Begin VB.Form lapshift 
   Caption         =   "Laporan Shift"
   ClientHeight    =   3255
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5040
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
      Height          =   255
      Left            =   1200
      OleObjectBlob   =   "lapshift.frx":0000
      TabIndex        =   9
      Top             =   2280
      Width           =   975
   End
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   480
      OleObjectBlob   =   "lapshift.frx":006E
      Top             =   2640
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   255
      Left            =   960
      OleObjectBlob   =   "lapshift.frx":02A2
      TabIndex        =   8
      Top             =   960
      Width           =   1815
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   255
      Left            =   960
      OleObjectBlob   =   "lapshift.frx":031C
      TabIndex        =   7
      Top             =   480
      Width           =   1695
   End
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\shift.rpt"
  .RetrieveDataFiles
'.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{transshift.mulai}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd 00:00:00") & "# And {transshift.akhir}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd 23:59:59") & "#"
...
b = Combo2.Text
.SelectionFormula = "month({transshift.mulai})=" & Combo1.Text & " and year({transshift.mulai})=" & Combo2.Text & ""
