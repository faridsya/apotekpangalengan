...
Begin VB.Form lapjurnal 
   Caption         =   "Laporan jurnal"
   ClientHeight    =   2790
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5040
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   960
      OleObjectBlob   =   "lapjurnal.frx":0000
      Top             =   2160
   End
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\jurnal.rpt"
  .RetrieveDataFiles
'.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{jurnal.tanggal}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd 00:00:00") & "# And {jurnal.tanggal}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd 23:59:59") & "#"
...
b = Combo2.Text
.SelectionFormula = "month({jurnal.tanggal})=" & Combo1.Text & " and year({jurnal.tanggal})=" & Combo2.Text & ""
