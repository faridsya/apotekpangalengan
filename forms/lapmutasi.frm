...
Begin VB.Form lapmutasi 
   Caption         =   "Laporan Mutasi Gudang"
   ClientHeight    =   2790
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   5040
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   4200
      OleObjectBlob   =   "lapmutasi.frx":0000
      Top             =   1800
   End
   ...
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
      Height          =   375
      Left            =   1080
      OleObjectBlob   =   "lapmutasi.frx":0234
      TabIndex        =   7
      Top             =   960
      Width           =   1575
   End
   Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
      Height          =   255
      Left            =   1080
      OleObjectBlob   =   "lapmutasi.frx":02AE
      TabIndex        =   8
      Top             =   480
      Width           =   1455
   End
End
Attribute VB_Name = "lapmutasi"
...
With CrystalReport1
  ...
  .ReportFileName = serperreport & "\mutasi.rpt"
  .RetrieveDataFiles
.Formulas(1) = "nama='" & nama_toko & "'"

  .WindowTitle = "laporan"
  If Option1.Value = True Then
  .SelectionFormula = "{mutasigudang.tanggal}>=#" & Format(DTPicker1.Value, "YYYY-mm-dd") & "# And {mutasigudang.tanggal}<=#" & Format(DTPicker2.Value, "YYYY-mm-dd") & "#"
...
b = Combo2.Text
.SelectionFormula = "month({mutasigudang.tanggal})=" & Combo1.Text & " and year({mutasigudang.tanggal})=" & Combo2.Text & ""
